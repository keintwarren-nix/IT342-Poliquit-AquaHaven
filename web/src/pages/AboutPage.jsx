...
export default function AboutPage() {
  useEffect(() => { document.title = "AquaHaven | About"; }, []);
        ...
        <section className="about-hero">
          ...
          <div className="about-hero__content">
            ...
            <p className="about-hero__sub">
              ...
              marketplace for everyone — from first-time goldfish owners to advanced reef builders.
            </p>
          </div>
        </section>
        ...
        <section className="about-section">
          <div className="about-mission">
            <div className="about-mission__text">
              <h2>Our Mission</h2>
              <p>We believe every aquarium tells a story. Our mission is to make the hobby accessible — with quality products, honest information, and a community that supports you at every stage of your journey.</p>
              <p>From freshwater planted tanks to vibrant saltwater reefs, we stock what you actually need, priced fairly and delivered with care.</p>
              <Link to="/products" className="about-cta-btn">Browse Our Collection →</Link>
            </div>
            <div className="about-mission__visual">
              <div className="about-stat"><span className="about-stat__num">500+</span><span className="about-stat__label">Products</span></div>
              <div className="about-stat"><span className="about-stat__num">5</span><span className="about-stat__label">Categories</span></div>
              <div className="about-stat"><span className="about-stat__num">100%</span><span className="about-stat__label">Passion-Driven</span></div>
            </div>
          </div>
        </section>
